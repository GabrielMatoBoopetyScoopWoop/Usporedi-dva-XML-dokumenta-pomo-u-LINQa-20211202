...
namespace XMLUsporedivanjeLINQ
{
    class Program
    {
        ...
        {
            XElement PrviXML = XElement.Load(@"C:\Users\Mato\source\repos\XMLUsporedivanjeLINQ\XML\prvi.xml");
            XElement DrugiXML = XElement.Load(@"C:\Users\Mato\source\repos\XMLUsporedivanjeLINQ\XML\drugi.xml");
            int brojpomagalo = 0;
